...
Public Class manageGradeForm
    Dim grade As New Grade()
    Dim student As New Student()
    Dim course As New Course()
    Dim data As String = "grade"
    Private Sub manageGradeForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub studentsButton_Click(sender As Object, e As EventArgs) Handles studentsButton.Click
        ...
        gradeDataGridView.DataSource = student.getStudents(command)
    ...
    Sub getDataFromGrid()
        ...
        If data = "student" Then
            ...
            studentIDTextBox.Text = gradeDataGridView.CurrentRow.Cells(0).Value.ToString()

        ElseIf data = "grade" Then

            studentIDTextBox.Text = gradeDataGridView.CurrentRow.Cells(0).Value.ToString()
            courseCodeComboBox.Text = gradeDataGridView.CurrentRow.Cells(3).Value

        End If

    End Sub

    Private Sub gradeDataGridView_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles gradeDataGridView.CellClick

        getDataFromGrid()

    End Sub

    Private Sub delGradeButton_Click(sender As Object, e As EventArgs) Handles delGradeButton.Click
